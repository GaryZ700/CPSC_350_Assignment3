...
class UserInput{
	...
	public:
		...
		fstream GetFile(string fileName, string msg="Please enter a file name: ", string error_msg="Invalid File Name! Please enter a new file name: ", ios::openmode mode=ios::in|ios::out);
	private:
